...
This repository contains all my projects, assignments, lab works, notes, and resources from the **3rd semester** of my Bachelor's in Computer Science / IT program.

It serves as a personal archive of coursework, code implementations, and study materials to track progress and reference in the future.

<grok-card data-id="b70f5c" data-type="image_card"></grok-card>
...
- [Key Subjects & Projects](#key-subjects--projects)
...
<grok-card data-id="a82895" data-type="image_card"></grok-card>
...
```bash
git clone https://github.com/PrageshShrestha/3rd-sem.git
cd 3rd-sem
